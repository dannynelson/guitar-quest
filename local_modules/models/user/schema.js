...
(function() {
  module.exports = {
    ...
    properties: {
      ...
      level: {
        description: 'Users current level. Note this is denormalized rather than being a virtual so that we can guarantee that level can go up but can never go down',
        type: 'integer',
        "default": 0
      },
      points: {
